...
def home(frame):
     ...
     msg = ctk.CTkLabel(new_frame, text=random.choice(sentences),fg_color='#1E3A8A', width=500, justify='center', font=('arial', 16, 'bold'), wraplength=450, text_color='#F3F4F6', corner_radius=10).place(x=250, y=500)
