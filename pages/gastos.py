...
def show_table(position):
    ...
    try:
        ...
        btn_add = ctk.CTkButton(position, command=lambda:addGasto(position), width=140, text="Adicionar Gasto", fg_color=('#3B82F6'), text_color='black', border_color='black', border_width=2).place(x=205, y=500)

        btn_remove = ctk.CTkButton(position, command=lambda:remove_gasto(position), width=140, text="Remover Gasto", fg_color=('#3B82F6'), text_color='black', border_color='black', border_width=2).place(x=355, y=500)
