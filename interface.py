...
btnGastos = ctk.CTkButton(framelateral, command=lambda:exibir_tabela(frameCentral), text="Gastos",  width=200, fg_color=('#F3F4F6'),text_color='#1E3A8A', border_color='#E5E7EB', border_width=1, hover_color='#3B82F6').place(x=0,y=250)
