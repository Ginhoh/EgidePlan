...
btnDashboard = ctk.CTkButton(framelateral, command=dashboard, text="Dashboard", fg_color=('transparent'),text_color='black', border_color='black', border_width=2).place(x=0,y=200)
